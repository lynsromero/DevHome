<footer class="k ca ef ij tg wm sn wg ym un">
  <div class="a">
    <div class="-ud-mx-4 sb wd alignitms">
      <div class="animate_top oc tf bk/3 fm/12">
        <div class="cb oc">
          <a class="lb rb pd" href="{{ route('home') }}">
            @if ($settings?->logo)
      ...
      <div class="animate_top oc tf ak/2 fm/12">
        <div class="cb oc">
          <h4 class="zh mj wa ah nh">Company</h4>
          <ul>
            <li>
      ...
      {{-- <div class="animate_top oc tf ak/2 fm/12">
        <div class="cb oc">
          <h4 class="zh mj wa ah nh">Customer</h4>
          <ul>
            <li>
      ...
      <div class="animate_top oc tf ak/2 fm/12">
        <div class="cb oc">
          ...
          <p>&copy;Copywright by DevHome 2026 </p>
        </div>
      </div>
    </div>
  </div>
...
<!-- ====== Back To Top Start ===== -->
<button class="vb xd yd qc yb ue do bf eo i aa ba ia" @click="window.scrollTo({top: 0, behavior: 'smooth'})"
  @scroll.window="scrollTop = (window.pageYOffset > 50) ? true : false" :class="{ 'tb' : scrollTop }">
